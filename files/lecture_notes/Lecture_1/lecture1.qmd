...
::: {.column width="40%"}
![](/files/lecture_notes/img/qr_code.png){width="100%"  fig-align="right" }
:::
...
::: {.column width="40%"}
![](/files/lecture_notes/img/jupyterlogo.png){ width="50%"  fig-align="right" }
...
::: {.column width="40%"}
![](/files/lecture_notes/img/email.png){ width="50%"  fig-align="right" }
...
::: {.column width="40%"}
![](/files/lecture_notes/img/data_science.png){ width="90%" fig-align="right"  }
:::
::::
