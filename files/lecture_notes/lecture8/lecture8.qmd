...
<script src="/files/lecture_notes/lecture8/lecture-interactive.js"></script>
```

## Welcome to Lecture 9 {.center}
...
## PDF Interpretation: *Height is Density* {.smaller}
...
## Interactive Distribution Explorer {.smaller}

::: {.interactive-demo}
### Continuous Distribution Visualizer

::: {.demo-controls}
<select id="contDistType" onchange="updateContinuousDistribution()">
<option value="uniform">Uniform</option>
<option value="normal">Normal</option>
<option value="exponential">Exponential</option>
</select>
<label>Parameter 1: <input type="number" id="contParam1" value="0" step="0.1" onchange="updateContinuousDistribution()"></label>
<label>Parameter 2: <input type="number" id="contParam2" value="1" step="0.1" onchange="updateContinuousDistribution()"></label>
<button onclick="showDistributionArea()">Calculate P(a ≤ X ≤ b)</button>
:::

::: {.demo-stats}
<div id="contDistStats" style="margin-top: 8px; font-size: 0.9em;">
<strong>Distribution Properties:</strong> <span id="contDistStatsText">Select parameters to see statistics</span>
</div>
:::

::: {.chart-container}
<canvas id="contDistChart"></canvas>
:::
:::

---

## The Normal Distribution: Star of Statistics {.smaller}
...
## Practice Problem 1: Uniform Distribution {.smaller}
...
## Practice Problem 2: Normal Distribution {.smaller}
...
## Practice Problem 3: Exponential Distribution {.smaller}
