  ...
  revealjs:
    ...
    includes:
      after-body: |
        ...
        <script>
        // Simple and direct solution toggle
        function setupSolutionToggles() {
          console.log('Setting up solution toggles...');
          
          // Find all solution toggle buttons
          const buttons = document.querySelectorAll('.solution-toggle');
          console.log('Found', buttons.length, 'solution toggle buttons');
          ...
          buttons.forEach(function(button, index) {
            ...
            button.onclick = function() {
              ...
              // Find the parent collapsible solution
              const parent = this.closest('.collapsible-solution');
              if (parent) {
                console.log('Found parent, toggling...');
                ...
                console.log('Toggle complete. Parent has open class:', parent.classList.contains('open'));
              } else {
        ...
        document.addEventListener('DOMContentLoaded', setupSolutionToggles);
        window.addEventListener('load', setupSolutionToggles);
        
        // For Reveal.js, also try after slides are ready
        if (typeof Reveal !== 'undefined') {
          Reveal.addEventListener('ready', setupSolutionToggles);
        }
        
        // Also try periodically
        setTimeout(setupSolutionToggles, 1000);
        setTimeout(setupSolutionToggles, 2000);
        setTimeout(setupSolutionToggles, 3000);
        </script>
jupyter: python3
execute:
  echo: false
