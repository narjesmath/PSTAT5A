...
format:
  revealjs:
      ...
      chalkboard: true
      preview-links: auto
      footer: "Understanding Data – Sampling Principles and Strategies © 2025"
      transition: slide
...
## The Foundation: Why Do We Sample? 🤔
...
fig = make_subplots(
    rows=2, cols=2,
    subplot_titles=("📊 Population: All UCSB Students (40,000)", 
                   "🎯 Our Sample (400 students)",
                   "💰 Cost Analysis", "⏰ Time Analysis"),
...
fig = make_subplots(
    rows=2, cols=3,
    subplot_titles=("🔍 Observational Study", "🧪 Randomized Experiment", "📊 Sample vs Population",
                   "⚠️ Confounding Variables", "🎲 Randomization Effect", "📈 Statistical Power"),
...
- ⚠️ Cannot establish causation due to confounding
:::
...
## Sampling Bias: What Can Go Wrong? ⚠️
...
## Standard Error: Measuring Our Uncertainty 📏
...
## Confidence Intervals: Our Bridge to the Population 🌉
...
## Sample Size Planning: Getting It Right 🎯
...
fig = go.Figure(data=[go.Table(
    header=dict(
        values=['<b>❌ Common Misconception</b>', '<b>✅ Correct Understanding</b>'],
